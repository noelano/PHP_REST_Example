...
define("ACTION_AUTHENTICATE", 99);

define("ACTION_GET_RECORD", 33);
define("ACTION_GET_RECORDS", 44);
define("ACTION_CREATE_RECORD", 55);
define("ACTION_UPDATE_RECORD", 66);
define("ACTION_DELETE_RECORD", 77);
define("ACTION_SEARCH_RECORDS", 88);
...
define("TABLE_PLAYER_POSITION_LENGTH", 10);
define("TABLE_PLAYER_TEAM_LENGTH", 25);

/* team table in DB */
define("TABLE_TEAM_NAME_LENGTH", 50);
define("TABLE_TEAM_COLOUR_LENGTH", 20);
